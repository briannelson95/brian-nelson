...
const getServerSideProps = async function(context) {
    ...
    const data = await _lib_sanity__WEBPACK_IMPORTED_MODULE_2__/* .client.fetch */ .L.fetch(_lib_queries__WEBPACK_IMPORTED_MODULE_3__/* .singleBlog */ .Ch, {
        slug
    });
    return {
        props: {
...
var __webpack_exports__ = __webpack_require__.X(0, [952,664,47], () => (__webpack_exec__(7602)));
